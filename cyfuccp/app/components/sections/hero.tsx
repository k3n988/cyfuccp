...
export function Hero() {
  return <section className="hero" id="home">
    <div className="hero-visual">
      <Image src={imageUrls.hero} alt="Christian Youth Fellowship group gathered at UCCP Bacolod" fill priority sizes="(max-width: 767px) 100vw, 62vw" />
    ...
    <div className="hero-container">
      <div className="hero-content">
        ...
        <div className="hero-actions">
          <a href="#contact" className="button button-pink"><Users size={16} /> Join the Community <ArrowRight size={14} /></a>
          <a href="#events" className="button button-outline"><CalendarDays size={16} /> View Events</a>
        </div>
        <blockquote>&quot;For where two or three gather in my name,<br />there am I with them.&quot;<br /><span>— Matthew 18:20</span></blockquote>
      </div>
    </div>
  </section>;
}
